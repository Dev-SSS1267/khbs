    ...
    <nav class="bg-gray-900 border-gray-700">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-coll">
                <ul
                    class="flex flex-col font-medium text-lg p-4 md:p-0 mt-4 border rounded md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:  bg-gray-800 md:bg-gray-900 border-gray-700">
                    <li>
